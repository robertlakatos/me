...
- V.    [POS tagging, N-gram]()
- VI.   [Embedding]()
- VII.  [Topic Modelling]()
- VIII. [Bayes-model, Sentiment analisis]()
- IX.   [Dimension reduction]()
- X.    [Linear regression, Sentiment analisis]()
- XI.   [Simple (dense) neural network, Named Entity Recognition]()
- XII.  [Recurrent neural network, Text Generation]()
- XIII. [Sequence-to-Sequence Models]()
