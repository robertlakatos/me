...
- Creating a project that you have to use AI solutions and you have to make/propose a decision based on your project results.  
     - You have to present it live and personally last lesson.
     ...
     - You must submit your project using the submission form by the deadline.
...
- **Submission deadline: 2026.12.06. 24:00 (Sunday)**
- [**Submission form (CLOSED)**]()
     ...
     - The Source link contains the ppt and source code.
