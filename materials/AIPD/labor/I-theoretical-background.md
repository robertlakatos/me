...
1. [DeepSeek](https://www.deepseek.com/en/)
    - Thinking
    - WebSearch
2. What kind of AI services are the recommendations?
    - [Google Gemmini](https://gemini.google.com/app)
    - [OpenAI ChatGPT](https://chatgpt.com/)
    - [Antropic Claude](https://claude.ai/new)
3. What is the difference between Google Gemini, ChatGPT and Claude?